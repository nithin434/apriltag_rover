    ...
    def state_machine(self):
        ...
        if self.state == self.IDLE:
            ...
            if self.lift_timer == 0:
                ...
                self.lift_timer = self.get_clock().now().nanoseconds / 1e9
            
            elif (self.get_clock().now().nanoseconds / 1e9) - self.lift_timer > 3.0:
            ...
            if self.current_tag_index == 0:
                ...
                self.get_logger().info('[STATE] Mission COMPLETE! Back at Charging Station')
